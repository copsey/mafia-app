...
namespace rkt {
	...
	bool equal_up_to_case(std::string_view s1, std::string_view s2);
	
	// Read the contents of `str` as an `int`, using `base` as the numeric base.
	//
	...
	// Read the contents of `str` as a `long`, using `base` as the numeric base.
	//
	...
	// Read the contents of `str` as a `long long`, using `base` as the numeric
	// base.
	//
	...
	// Read the contents of `str` as an `unsigned long`, using `base` as the
	// numeric base.
	//
	...
	// Read the contents of `str` as an `unsigned long long`, using `base` as the
	// numeric base.
	//
