...
//         }
      ...
      err_params["player"] = _game_log->get_name(*e.player);
      ...
      err_params["voter"] = _game_log->get_name(*e.voter);
      err_params["target"] = _game_log->get_name(*e.target);
      ...
      err_params["caster"] = _game_log->get_name(*e.caster);
      err_params["target"] = _game_log->get_name(*e.target);
